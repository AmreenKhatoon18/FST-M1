REM   Script: Activity(9,10,11)_New
REM   Activity(9,10,11)_New
...
SELECT a.customer_name AS "Customer Name", a.city, b.salesman_name AS "Salesman", b.commission FROM customer a  
INNER JOIN salesman b ON a.salesman_id=b.salesman_id;
